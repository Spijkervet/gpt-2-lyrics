...
def generate(
    ...
    requires_preprocessing = False  # args.model_type in PREPROCESSING_FUNCTIONS.keys()
    if requires_preprocessing:
        ...
        prefix = prefix if prefix else padding_text
        encoded_prompt = tokenizer.encode(
...
def main():
    ...
    logger.warning(
        f"device: {args.device}, n_gpu: {n_gpu}, 16-bits training: {args.fp16}"
    )
